...
type Props = {
    opening_balances: Paginated<OpeningBalanceRow>;
...
export default function OpeningBalancesIndex({
    ...
    return (
        <>
            <Head title="المبالغ غير المسددة" />
            <FormCard
                title="المبالغ غير المسددة"
                description="تسجيل المبالغ التي ما زال الموزعون مدينين بها للشركة دون إنشاء فاتورة"
            ...
            >
                <div className="space-y-4">
                            ...
                            <TableBody className="divide-y divide-gray-200 dark:divide-gray-700">
                                {openingBalances.data.length === 0 ? (
                                    <TableRow>
                                        ...
                                        >
                                            لا توجد مبالغ غير مسددة
                                        </TableCell>
                                    </TableRow>
                                ) : (
                                    openingBalances.data.map(
                                        (openingBalance) => (
                                            <TableRow key={openingBalance.id}>
                                                ...
                                                <TableCell className="text-end">
                                                    <div className="inline-flex items-center justify-end gap-2">
                                                        ...
                                                        {openingBalance.can_delete && (
                                                            <DeleteButton
                                                                href={OpeningBalanceController.destroy.url(
                                                                    openingBalance.id,
                                                                )}
                                                                confirmMessage="هل أنت متأكد من حذف هذا المبلغ غير المسدد؟"
                                                            />
                                                        )}
                                                    </div>
                                                </TableCell>
                    ...
                    <PaginationLinks
                        meta={openingBalances}
                        storageKey="opening-balances"
                    />
                </div>
            </FormCard>
        </>
...
OpeningBalancesIndex.layout = {
    breadcrumbs: [{ title: 'المبالغ غير المسددة', href: index() }],
};
